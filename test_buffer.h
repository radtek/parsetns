...
//uint16_t buf_len[BUFFER_NUM] = {264, 8, 264, 32, 156, 127, 197, 189, 165, 427, 154};
...
uint16_t buf_smallbuf1_len = sizeof smallbuf1 / sizeof smallbuf1[0];

unsigned char smallbuf2[] = { //connect
	0x01, 0x2c
};
uint16_t buf_smallbuf2_len = sizeof smallbuf2 / sizeof smallbuf2[0];
